...
PLIST="$ROOT/launchd/parameter-golf-overnight-round3.plist"
LABEL="com.sanilbaweja.parameter-golf.overnight-round3"
UID_NUM="$(id -u)"
...
mkdir -p "$ROOT/logs/overnight_local_ab_round3"
chmod +x "$ROOT/scripts/run_overnight_local_ab_round3.sh"
