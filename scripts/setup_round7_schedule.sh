...
PLIST="$ROOT/launchd/parameter-golf-overnight-round7.plist"
LABEL="com.sanilbaweja.parameter-golf.overnight-round7"
UID_NUM="$(id -u)"
...
mkdir -p "$ROOT/logs/overnight_local_ab_round7"
chmod +x "$ROOT/scripts/run_overnight_local_ab_round7.sh"
