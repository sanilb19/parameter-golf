...
PLIST="$ROOT/launchd/parameter-golf-overnight-round5.plist"
LABEL="com.sanilbaweja.parameter-golf.overnight-round5"
UID_NUM="$(id -u)"
...
mkdir -p "$ROOT/logs/overnight_local_ab_round5"
chmod +x "$ROOT/scripts/run_overnight_local_ab_round5.sh"
