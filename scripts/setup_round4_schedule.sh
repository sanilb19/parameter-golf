...
PLIST="$ROOT/launchd/parameter-golf-overnight-round4.plist"
LABEL="com.sanilbaweja.parameter-golf.overnight-round4"
UID_NUM="$(id -u)"
...
mkdir -p "$ROOT/logs/overnight_local_ab_round4"
chmod +x "$ROOT/scripts/run_overnight_local_ab_round4.sh"
